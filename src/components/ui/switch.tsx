...
export function Switch({ checked, className, disabled, loading = false, ...props }: SwitchProps) {
  return (
    <button
      ...
      className={cn(
        "inline-flex h-7 w-12 items-center rounded-full border border-input transition-[background-color,border-color,box-shadow,opacity] duration-base ease-standard hover:border-primary/60 motion-safe:active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-60",
