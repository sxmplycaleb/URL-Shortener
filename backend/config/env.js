...
export function getEnv() {
  ...
  return {
    ...
    otpExpiryMinutes: integerValue("OTP_EXPIRY_MINUTES", 5, { min: 1, max: 60 }),
    otpResendCooldownMs: integerValue("OTP_RESEND_COOLDOWN_MS", 60_000, { min: 0 }),
    otpGenerationRateLimitWindowMs: numberValue("OTP_GENERATION_RATE_LIMIT_WINDOW_MS", 15 * 60 * 1000),
    ...
    // metaWhatsAppTemplateLanguage: process.env.META_WHATSAPP_TEMPLATE_LANGUAGE || "en_US",
